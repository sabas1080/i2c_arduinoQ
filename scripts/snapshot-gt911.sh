...
LOCAL_OUT="/path/to/repo/Documents/electroniccats/i2c_arduinoQ/notes/snapshot-${TS}-${LABEL}.txt"
...
sshpass -e scp -o StrictHostKeyChecking=accept-new arduino@192.168.0.XXX:$REMOTE_OUT $LOCAL_OUT 2>&1
